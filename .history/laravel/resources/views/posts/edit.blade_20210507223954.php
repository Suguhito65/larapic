    ...
    <div class="col-md-6 offset-md-3">
        ...
        <div class="card-header text-center bg-dark text-white" for="exampleFormControlTextarea1" style="font-size: 1.5em">編集</div>
            <form action="/posts/edit" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <p class="card-text">
                        <textarea class="form-control" name="body" id="exampleFormControlTextarea1" rows="3" placeholder="#(半角)を頭につけるとタグになります">{{$post->body}}</textarea>
                    </p>
                    <p class="card-text">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <input class="btn btn-primary mt-3 px-4" type="submit" value="変更する">

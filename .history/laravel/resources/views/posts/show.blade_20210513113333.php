            ...
            <div class="card-body" style="background: #fafafa">
                ...
                <div class="text-center">
                    @if($post->is_liked_by_auth_user())
                        <a href="{{ route('posts.unlike', ['id' => $post->id]) }}" class="btn btn-primary btn-sm"><i class="far fa-heart" style="color: #ee82ee"></i><span class="badge">{{ $post->likes->count() }}</span></a>
                    @else
                        <a href="{{ route('posts.like', ['id' => $post->id]) }}" class="btn btn-secondary btn-sm"><i class="far fa-heart" style="color: #ee82ee"></i><span class="badge">{{ $post->likes->count() }}</span></a>
                    @endif
                </div>
                @can('edit', $post)

<div class="card mb-5">
    ...
    <div class="card-body">
        <div class="card-title">
            <i class="fas fa-user-circle" style="color: #0000cd"></i><span class="font-weight-bold" style="color: #0000cd"> 投稿者</span>
            <a href="{{ route('users.show', $post->user_id) }}" class="text-dark btn">
                {{ $post->user->name }}
            </a>
        </div>
        <div class="card-title text-break">
            <i class="fas fa-comment-dots" style="color: #0000cd"></i>
            <span class="font-weight-bold" style="color: #0000cd"> 投稿</span>　{{ $post->body }}
        </div>
        <div class="card-title">
            <i class="fas fa-tag" style="color: #0000cd"></i><span class="font-weight-bold" style="color: #0000cd"> タグ</span>

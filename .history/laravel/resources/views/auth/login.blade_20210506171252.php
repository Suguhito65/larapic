            ...
            <div class="card-body">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary mt-4" style="border-radius: 1.1em">
                            {{ __('ログイン') }}
                        </button>
                    </div>
                </form>
                ...
                <div class="text-center">
                    <a href="/login/google" class="btn text-white" role="button" style="background: #ff4500; border-radius: 2em">

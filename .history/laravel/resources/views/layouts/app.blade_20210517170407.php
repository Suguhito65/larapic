...
<body style="background: linear-gradient(#e0ffff, #faffff, #e0ffff)">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm sticky-top" style="background: linear-gradient(45deg, #00bfff, #00f, #00bfff)">
            <div class="container">
                <a class="navbar-brand text-white" href="{{ url('/') }}" style="font-size: 2em">
                    <i class="fas fa-ruler-combined" style="font-size: 1.1em"></i>arap<i class="fas fa-info" style="font-size: 0.6em"></ic
                </a>
